...
using Cleanception.Infrastructure.Persistence.ConnectionString;
using Cleanception.Infrastructure.Persistence.Context;
using Cleanception.Infrastructure.Persistence.Initialization;
using Cleanception.Infrastructure.Persistence.Repository;
...
namespace Cleanception.Infrastructure.Persistence;
...
internal static class Startup
{
    ...
    internal static IServiceCollection AddPersistence(this IServiceCollection services, IConfiguration config)
    {
        ...
        _logger.Information($"Current DB Connection : {rootConnectionString}");
    ...
    internal static DbContextOptionsBuilder UseDatabase(this DbContextOptionsBuilder builder, string dbProvider, string connectionString)
    {
        switch (dbProvider.ToLowerInvariant())
        {
            ...
            case DbProviderKeys.SqlServer:
                return builder.UseSqlServer(connectionString, e => e.MigrationsAssembly("Migrators.MSSQL"))
