...
internal static class Startup
{
    ...
    internal static IServiceCollection AddUserValidatorMiddleware(this IServiceCollection services, IConfiguration config)
    {
        services.AddScoped<UserValidatorMiddleware>();

        return services;
    }

    internal static IApplicationBuilder UseUserValidatorMiddleware(this IApplicationBuilder app, IConfiguration config)
    {
